...
* [Лямбда функции](#Лямбда-функции)
  * [Вынесение лямбда функций за скобки](#Вынесение-лямбда-функций-за-скобки)
  * [Вынесение тела лямбда функции](#Вынесение-тела-лямбда-функции)
  * [Лямбда функции без параметров](#Лямбда-функции-без-параметров)
  * [Лямбда функции с одним параметром и одним действием в теле](#Лямбда-функции-с-одним-параметром-и-одним-действием-в-теле)
  * [Лямбда функции с несколькими параметрами и одним действием в теле](#Лямбда-функции-с-несколькими-параметрами-и-одним-действием-в-теле)
